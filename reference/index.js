...
router.get('/heatmap_base', function(req, res, next) {
   res.render('heatmap_base.html', { title: 'ExpressTitle' });
});


router.get('/base', function(req, res, next) {
   res.render('base.html', { title: 'ExpressTitle' });
});


router.get('/query/single/info_java', query.get_single_info_java);

router.get('/query/single/eagle/create', query.create_eagle_trace);
router.get('/query/single/eagle/add', query.add_eagle_trace);
router.get('/query/single/eagle/add_single', query.add_single_eagle_trace);
router.get('/query/single/eagle/get', query.get_eagle_trace);
